<%-- 
    Document   : error500
    Created on : 04-abr-2017, 20:42:45
    Author     : Manga
--%>
        ...
        <div class="sombra">
            <div class="nucleo">
                ...
                <div class="contenido">
                    ...
                    <div class="error">
                        <div>  
                            <c:out default="Error 404" value="${'Error '}${requestScope['javax.servlet.error.status_code']}${'. '}${'Internal Server Error: '}${requestScope['javax.servlet.error.message']}"/> 
                        </div>
                        <c:choose>
