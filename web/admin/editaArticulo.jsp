<%-- 
    Document   : editaArticulo
    Created on : 07-may-2017, 21:03:04
    Author     : Manga
--%>
        ...
        <div class="sombra">
            <div class="nucleo">
                ...
                <div class="contenido">
                    ...
                    <form id="fArtic" name="fArtic" action="EditaArticulo" method="post" enctype="multipart/form-data">
                        <fieldset> 
                            ...
                            <div class="field">
                                ...
                                <input type="text" ${nombre==null? required:""}name="nombre" id="nombre" size="55" value="${nombre!=null ? nombre : ''}">
                            </div>
                            <div>
                                <div class="left">
                                    <div class="field">
                                        ...
                                        <input type="text" name="codigo" id="codigo" size="15" value="${param.idArt}">
                                    </div>
                                </div>
                                <div class="right">
                                    <div class="field">
                                        ...
                                        <input type="text" ${pvp==null? required:""} name="pvp" id="pvp" size="15" value="${pvp!=null || pvp!=0.0 ? pvp : ''}">
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="left">
                                    <div class="field">
                                        ...
                                        <select name="tipo"  ${tipo==null? required:""} id="tipo">
                            ...
                            <div>
                                <div class="left">
                                    <div class="field">
                                        <img src="../img/fotosElectr/${foto}" alt="foto Articulo">
                                    </div>
                                </div>
