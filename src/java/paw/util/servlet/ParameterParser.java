...
public class ParameterParser {
  ...
  /**
   * Obtiene el parámetro como una fecha, con el patrón de fecha especificado.
   *
   * @param nombre nombre del parámetro
   * @param patron patrón de fecha (ver en {@link java.text.SimpleDateFormat})
   * @exception ParameterNotFoundException si no se encuentra el parámetro
   * @exception ParseException si el parámetro no pueder ser convertido a una 
   * fecha
  ...
  /**
   * Obtiene el parámetro como una fecha, con el patrón de fecha especificado.
   * Devuelve el valor por defecto si no se puede realizar la conversión.
   *
   * @param nombre nombre del parámetro
  ...
  public Date getDateParameter(String nombre, String patron, Date def) {
    try { return getDateParameter(nombre, patron); }
    catch (Exception e) { return def; }
  }
  ...
  public Calendar getCalendarParameter(String nombre, String patron, Calendar def) {
    try { return getCalendarParameter(nombre, patron); }
    catch (Exception e) { return def; }
  }
